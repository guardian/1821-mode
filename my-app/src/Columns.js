...
function Columns() {
    return (
        <div class="column-container">
            <Api article={articlesJson[0]} percentage="100" />
            <hr />
            ...
            <hr />
            <img src={SeigelsSyrupAd} alt="Old fashioned advert for Seigel's Syrup" />
            <img src={PeerlessDictionaryAd} alt="Old fashioned advert for the Peerless Dictionary" />
            <hr />
            <Api article={articlesJson[2]} percentage="60" />
            <hr />
            <img src={HartSonPeardCoAd} alt="Old fashioned advert for communion plate manufacturers" />
            <hr />
            <Api article={articlesJson[3]} percentage="100" />
            <hr />
            <Api article={articlesJson[4]} percentage="70" />
                <hr />
            ...
            <img src={PuritySaltAd} alt="Old fashioned advert for Purity table salt" />
                <hr />
                <Api article={articlesJson[5]} percentage="90" />
        </div>
    )
}
