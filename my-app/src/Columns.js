...
function Columns() {
    return (
        <div class="column-container">
            <Api article={articlesJson[0]} percentage="80" />
            <hr />
